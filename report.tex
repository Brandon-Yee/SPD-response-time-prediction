...
\title{Understanding and Predicting Police Response to 911 Calls}
...
\author{%
  Michael ~Rhoads%\thanks{Use footnote for providing further information
  ...
  Seattle, WA 98195 \\
  \texttt{mrhoad2@uw.edu} \\
  % examples of more authors
  \And
  Brandon Yee%\thanks{more info} \\% Coauthor
    \\
  Department of Electrical and Computer Engineering \\
...
\begin{abstract}
  Discussion about understanding and predicting police response to 911 calls
